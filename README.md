AlohaMini 是一款基于 LeRobot 和 SO100 打造的 Aloha 机器人训练套件，专为科研与教学应用设计。该套件配备了 2 个leader臂、2 个follower臂以及 3 个摄像头，整体固定于一个方形木板上。相较于 LeRobot，AlohaMini 不仅显著增强了调试能力，还统一了数据采集标准。
...
注1：Ubuntu系统上的默认规律是先插入的是0，第二个插入的是2，然后是4，6
注2：多个摄像头不能插在一个Hub上，1个Hub上仅支持1个摄像头
注3：笔记本电脑通常都自带一个默认摄像头，这个摄像头我们用不上，忽略掉它即可
注4：每次重启电脑后，都要执行该操作
