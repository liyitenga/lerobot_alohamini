...
if __name__ == "__main__":
    ...
    parser.add_argument('command', choices=['reset_all_motors_to_midpoint', 'reset_all_motors_torque','get_all_motors_states', 'position_to_angle_with_offset',
                                            'set_motor_id','get_all_motors_id','move_motors_by_code','move_motors_by_script'],
    ...
    parser.add_argument("--SetID", type=int, help="Targeted ID of the current motor (e.g. 1,2,3)")
    ...
    if args.command == 'reset_motors_to_midpoint':
        ...
        configure_motor_id(args.port,args.ID,args.SetID)
