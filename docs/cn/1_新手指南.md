...
由于lerobot_alohamini是AlohaMini的配套软件，所以内置了AlohaMini相关的配置文件，请注意，本教程以AlohaMini Solo（1主1从）为样例，如果您使用的是AlohaMini Duet（2主2从），请替换教程中的am_solo.yaml为am_duet.yaml
...
### 5. 配置机械臂端口号
将机械臂连接好电源，并通过USB与电脑相连，接下来确认机械臂的端口号。
...
第二步： 修改configs/robot/am_solo.yaml，配置为正确的摄像头序号
